...
class Room implements \JsonSerializable
{
     ...
     *
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\Zulu", mappedBy="room", cascade={"persist"})
     *
     * @var Zulu $zulu
     */
    private $zulu;
     ...
     *
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\Computer", mappedBy="room", cascade={"persist"})
     *
